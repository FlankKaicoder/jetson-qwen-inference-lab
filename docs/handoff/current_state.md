...
- Gate A1 is `PASS`; final B/C remain `NOT_STARTED`; readiness is `READY_FOR_EXP04_V2`. The 256^3 actual event window was 341 ms and is retained as a calibration observation.
