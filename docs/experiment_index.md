...
| Exp03 | CUDA Matrix Transpose initialization, correctness and benchmark | `exp/03-matrix-transpose` | `IN_PROGRESS` | Gate A `PASS`; Gate B `INCONCLUSIVE`; Gate C `NOT_STARTED` | `10f0df6` (benchmark harness) | `experiments/Exp03-matrix-transpose/README.md` | `experiments/Exp03-matrix-transpose/benchmark/raw/` | 828/828 bitwise correctness PASS; two benchmark runs retain CV >5%; Nsight not started. | Benchmark stability investigation |
