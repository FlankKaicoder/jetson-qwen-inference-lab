...
| Exp03 | CUDA Matrix Transpose initialization, correctness and benchmark | `exp/03-matrix-transpose` | `IN_PROGRESS` | Gate A `PASS`; Gate B `PASS`; Gate C `NOT_STARTED` | `88a2768` (adaptive timing fix) | `experiments/Exp03-matrix-transpose/README.md` | `experiments/Exp03-matrix-transpose/benchmark/raw/` | 828/828 bitwise correctness PASS; adaptive Diagnostic A and Formal Benchmark V2 stability PASS; Nsight not started. | Gate C profiling |
