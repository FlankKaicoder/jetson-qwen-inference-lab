...
| Exp04 | CUDA GEMM tiling and WMMA | `exp/04-gemm` | `PASS` | A1/A2/A3/B/C `PASS` | `50689df`, `1c23a21`, `c3a938b`, closure commit | `experiments/Exp04-gemm/README.md` | `experiments/Exp04-gemm/benchmark/raw/` | V2-T16 selected; WMMA HMMA SASS evidence; formal cross-version benchmark stable; Exp04 closed. | Learning review; Exp05 not started |
