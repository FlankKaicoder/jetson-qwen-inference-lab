...
| Exp04 | CUDA GEMM tiling and WMMA | `exp/04-gemm` | `INCONCLUSIVE` | A1/A2/B/C `PASS`; A3 `INCONCLUSIVE` | `50689df`, `1c23a21`, `c3a938b`; closure pending | `experiments/Exp04-gemm/README.md` | `experiments/Exp04-gemm/benchmark/raw/` | V2-T16 selected; formal benchmark and HMMA SASS evidence present; WMMA original-FP32 precision-impact row missing. | Add second WMMA reference comparison, then close; Exp05 not started |
