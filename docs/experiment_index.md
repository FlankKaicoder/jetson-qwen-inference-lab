...
| Exp04 | CUDA GEMM initial V0/V1 | `exp/04-gemm` | `BLOCKED` | A1 `NOT_EXECUTED`; B/C `NOT_STARTED` | `UNCOMMITTED` (base `fab89aef`) | `experiments/Exp04-gemm/README.md` | `experiments/Exp04-gemm/` | Design and V0/V1 source initialized; Jetson CUDA executor unavailable; no benchmark conclusion. | Restore Jetson executor, then run V1 correctness |
