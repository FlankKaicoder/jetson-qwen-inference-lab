...
| Exp04 | CUDA GEMM initial V0/V1 | `exp/04-gemm` | `RUNNING` | A1 `PASS`; final B/C `NOT_STARTED` | `50689df` plus results commit | `experiments/Exp04-gemm/README.md` | `experiments/Exp04-gemm/benchmark/raw/` | 13/13 V1 correctness PASS; seven-trial benchmark CV <= 0.505%; no compute/memory-bound conclusion; V2/V3 not started. | Review V1 evidence, then authorize V2 design |
