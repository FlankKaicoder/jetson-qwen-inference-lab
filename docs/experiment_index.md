...
| Exp03 | CUDA Matrix Transpose initialization and correctness | `exp/03-matrix-transpose` | `IN_PROGRESS` | Gate A `PASS`; Gate B/C `NOT_STARTED` | `5ab4555` (correctness closure) | `experiments/Exp03-matrix-transpose/README.md` | `experiments/Exp03-matrix-transpose/benchmark/raw/` | 828/828 bitwise correctness PASS; V1/V2 grid boundary bug fixed; no benchmark or Nsight run. | Exp03 benchmark authorization |
