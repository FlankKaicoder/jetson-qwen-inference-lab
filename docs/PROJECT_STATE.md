...
| Current experiment | Phase 2.2-B2 — real Qwen3 Layer 0 integration via dual-environment bridge |
...
| Current Gate | Phase 2.2-B2 gates B2-1..B2-8 `PASS (bounded)`; full/28-layer runtime remains not started |
| Readiness | Real Layer 0 HF/portable/TRT FP16 path validated; ready for explicitly authorized real multilayer integration |
