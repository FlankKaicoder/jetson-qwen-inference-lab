...
def main():
    ...
    try:
        ...
        result["memory"]["peak_allocated_bytes"] = torch.cuda.max_memory_allocated(device)
        result["memory"]["peak_reserved_bytes"] = torch.cuda.max_memory_reserved(device)
        result["memory"]["allocated_after_bytes"] = torch.cuda.memory_allocated(device)
        result["memory"]["reserved_after_bytes"] = torch.cuda.memory_reserved(device)
        result["runtime_log"] = {
